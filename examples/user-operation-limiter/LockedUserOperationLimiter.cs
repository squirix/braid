...
/// <summary>Demonstrates a synchronized per-user operation limiter.</summary>
public sealed class LockedUserOperationLimiter
{
    ...
    /// <summary>Exits a previously entered operation slot for the configured user.</summary>
    public void Exit()
    {
        lock (_gate)
        {
