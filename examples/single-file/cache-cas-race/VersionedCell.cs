...
/// <summary>A minimal in-memory cell with versioned reads and compare-and-set writes.</summary>
    ...
    where T : notnull
{
    ...
    /// <summary>Reads the current entry under a lock.</summary>
    /// <param name="cancellationToken">A cancellation token.</param>
    ...
    /// <summary>Unconditionally sets a new value and increments the version.</summary>
